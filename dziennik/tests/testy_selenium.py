...
class TestProject(StaticLiveServerTestCase):
    ...
    """ T146 Zarządzaniem profilem dziecka użytkownika - edycja danych niepoprawne - brak imienia"""     
    def test_T146(self):
        self.browser.get('http://localhost:8000/login')
        self.browser.maximize_window()
        login = self.browser.find_element_by_xpath('/html/body/div/div/div/div/form/div[2]/input')
        ...
        button.submit()
        time.sleep(1)
        childern = self.browser.find_element_by_xpath('/html/body/nav/div/ul/li[2]/a')
        childern.click()
        time.sleep(1)
        self.browser.find_element_by_xpath('/html/body/main/div[2]/div/div/div/div[1]/div').click()
        time.sleep(1)
        self.browser.find_element_by_xpath('/html/body/main/div[2]/div/div/div/div[2]/div/form/div/div/div[1]/button').click()
        name = self.browser.find_element_by_xpath('/html/body/div[2]/div/div/div/div/form/div[2]/p/input')
        surname = self.browser.find_element_by_xpath('/html/body/div[2]/div/div/div/div/form/div[3]/p/input')
        age = self.browser.find_element_by_xpath('/html/body/div[2]/div/div/div/div/form/div[4]/p/input')
        name.clear()
        surname.clear()
        age.clear()
        name.send_keys('Adam')
        surname.send_keys('Nowak')
        age.send_keys('12')
        self.browser.find_element_by_xpath('/html/body/div[2]/div/div/div/div/form/div[5]/button[2]').click()
        self.wait.until(EC.presence_of_element_located((By.CLASS_NAME, 'popup')))
        self.browser.close()

    """ T147 Zarządzaniem profilem dziecka użytkownika - edycja danych niepoprawne - brak imienia"""     
    def test_T147(self):
        self.browser.get('http://localhost:8000/login')
        self.browser.maximize_window()
        login = self.browser.find_element_by_xpath('/html/body/div/div/div/div/form/div[2]/input')
        ...
        age.send_keys('12')
        self.browser.find_element_by_xpath('/html/body/div[2]/div/div/div/div/form/div[5]/button[2]').click()
        self.wait.until(EC.text_to_be_present_in_element((By.XPATH, "/html/body/div[2]/div/div/div/div/form/div[2]/span/p"), "Nie podano imienia"))
        self.browser.close()

    """ T148 Zarządzaniem profilem dziecka użytkownika - edycja danych niepoprawne - za krótkie imię"""     
    def test_T148(self):
        self.browser.get('http://localhost:8000/login')
        self.browser.maximize_window()
        login = self.browser.find_element_by_xpath('/html/body/div/div/div/div/form/div[2]/input')
        ...
        age.send_keys('12')
        self.browser.find_element_by_xpath('/html/body/div[2]/div/div/div/div/form/div[5]/button[2]').click()
        self.wait.until(EC.text_to_be_present_in_element((By.XPATH, "/html/body/div[2]/div/div/div/div/form/div[2]/span/p"), "Podano niewłaściwe imie"))
        self.browser.close()

    """ T149 Zarządzaniem profilem dziecka użytkownika - edycja danych niepoprawne - brak imienia"""     
    def test_T149(self):
        self.browser.get('http://localhost:8000/login')
        self.browser.maximize_window()
        login = self.browser.find_element_by_xpath('/html/body/div/div/div/div/form/div[2]/input')
    ...
    """ T150 Zarządzaniem profilem dziecka użytkownika - edycja danych niepoprawne - brak nazwiska"""     
    def test_T150(self):
        self.browser.get('http://localhost:8000/login')
        self.browser.maximize_window()
        login = self.browser.find_element_by_xpath('/html/body/div/div/div/div/form/div[2]/input')
        ...
        age.send_keys('12')
        self.browser.find_element_by_xpath('/html/body/div[2]/div/div/div/div/form/div[5]/button[2]').click()
        self.wait.until(EC.text_to_be_present_in_element((By.XPATH, "/html/body/div[2]/div/div/div/div/form/div[3]/span/p"), "Nie podano nazwiska"))
        self.browser.close()

    """ T151 Zarządzaniem profilem dziecka użytkownika - edycja danych niepoprawne - za krótkie nazwisko"""     
    def test_T151(self):
        self.browser.get('http://localhost:8000/login')
        self.browser.maximize_window()
        login = self.browser.find_element_by_xpath('/html/body/div/div/div/div/form/div[2]/input')
        ...
        age.send_keys('12')
        self.browser.find_element_by_xpath('/html/body/div[2]/div/div/div/div/form/div[5]/button[2]').click()
        self.wait.until(EC.text_to_be_present_in_element((By.XPATH, "/html/body/div[2]/div/div/div/div/form/div[3]/span/p"), "Podano niewłaściwe nazwisko"))
        self.browser.close()


    """ T152 Zarządzaniem profilem dziecka użytkownika - edycja danych niepoprawne - cyfra w nazwisku"""     
    def test_T152(self):
        self.browser.get('http://localhost:8000/login')
        self.browser.maximize_window()
        login = self.browser.find_element_by_xpath('/html/body/div/div/div/div/form/div[2]/input')
    ...
    """ T153 Zarządzaniem profilem dziecka użytkownika - edycja danych niepoprawne - za mały wiek"""     
    def test_T153(self):
        self.browser.get('http://localhost:8000/login')
        self.browser.maximize_window()
        login = self.browser.find_element_by_xpath('/html/body/div/div/div/div/form/div[2]/input')
        ...
        age.send_keys('0')
        self.browser.find_element_by_xpath('/html/body/div[2]/div/div/div/div/form/div[5]/button[2]').click()
        self.wait.until(EC.text_to_be_present_in_element((By.XPATH, "/html/body/div[2]/div/div/div/div/form/div[4]/span/p"), "Podano niewłaściwy wiek"))
        self.browser.close()


    """ T154 Zarządzaniem profilem dziecka użytkownika - edycja danych niepoprawne - za duży wiek"""     
    def test_T154(self):
        self.browser.get('http://localhost:8000/login')
        self.browser.maximize_window()
        login = self.browser.find_element_by_xpath('/html/body/div/div/div/div/form/div[2]/input')
